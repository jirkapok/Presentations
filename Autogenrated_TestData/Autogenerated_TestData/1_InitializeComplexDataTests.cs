...
public class InitializeComplexDataTests
{
    ...
    [Test]
    public void Test1_Autogenerated_Customized_Properties()
    {
    ...
    [Test]
    public void Test1_Autogenerated_Customized_Constructor()
    {
        // No constructor parameters customization
        var person = new Fixture()
            .Build<Student>()
            .FromFactory((DateTime birth, Guid id) => new Student("Karel", "Vokurka", birth, id))
            .OmitAutoProperties()
            .Create();
